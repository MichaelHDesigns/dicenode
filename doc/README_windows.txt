...
Intro
-----
Dicenode (DNO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Dicenode utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dicenode-qt.exe.

Dicenode Core is the original Dicenode client and it builds the backbone of the network.
However, it downloads and stores the entire history of Dicenode transactions;
