...
In order to support loading of multiple wallets in dicenode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dicenode.cpp.
...
Changes to dicenode.cpp
----------------------
dicenode.cpp is the entry point into dicenode-qt, and as such, will require some minor modifications to provide hooks for
