...
This mechanism has been integrated into Bitcore-Node-Dicenode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bulpgame/insight-api-dicenode#web-socket-api](https://github.com/bulpgame/insight-api-dicenode#web-socket-api)
* API: [https://github.com/bulpgame/insight-api-dicenode#swifttx-transactions](https://github.com/bulpgame/insight-api-dicenode#swifttx-transactions)
...
By default, the Dicenode Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dicenode Core daemon:
