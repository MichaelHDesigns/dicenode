...
RESOURCES += src/qt/dicenode.qrc src/qt/dicenode_locale.qrc

TRANSLATIONS += src/qt/locale/dicenode_bg.ts \
                src/qt/locale/dicenode_de.ts \
                src/qt/locale/dicenode_en.ts \
                src/qt/locale/dicenode_es.ts \
                src/qt/locale/dicenode_fi.ts \
                src/qt/locale/dicenode_fr.ts \
                src/qt/locale/dicenode_it.ts \
                src/qt/locale/dicenode_ja.ts \
                src/qt/locale/dicenode_pl.ts \
                src/qt/locale/dicenode_pt.ts \
                src/qt/locale/dicenode_ru.ts \
                src/qt/locale/dicenode_sk.ts \
                src/qt/locale/dicenode_sv.ts \
                src/qt/locale/dicenode_vi.ts \
                src/qt/locale/dicenode_zh_CN.ts \
                src/qt/locale/dicenode_zh_TW.ts
