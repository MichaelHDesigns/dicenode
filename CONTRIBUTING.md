Contributing to Dicenode Core
==================================

The Dicenode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dicenode Core project, and is not to be
confused with overall Dicenode Network Protocol consensus changes.

Whether a pull request is merged into Dicenode Core rests with the project merge
...
Patches that change Dicenode consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dicenode consensus, it must have been
...
The project leader is the release manager for each Dicenode Core release.
