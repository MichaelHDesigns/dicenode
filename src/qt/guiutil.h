...
/** Utility functions used by the Dicenode Qt UI.
 */
namespace GUIUtil
{
...
// Render DNO addresses in monospace font
...
// Parse "dicenode:" URI into recipient object, return true on successful parsing
