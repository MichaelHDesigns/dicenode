...
// Repair parameters
const QString DICENODEWALLET("-dicenodewallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_dicenodewallet, SIGNAL(clicked()), this, SLOT(walletDicenode()));
...
/** Restart wallet with "-dicenodewallet" */
void RPCConsole::walletDicenode()
{
    buildParameterlist(DICENODEWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Dicenode RPC console.") + "<br>" +
