...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dicenode Core"),
     ...
     * override -datadir in the dicenode.conf file in the default data directory
     * (to be consistent with dicenoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
