...
/* Dicenode GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dicenode"
#define QAPP_ORG_DOMAIN "dicenodegame.online"
#define QAPP_APP_NAME_DEFAULT "Dicenode-Qt"
#define QAPP_APP_NAME_TESTNET "Dicenode-Qt-testnet"
