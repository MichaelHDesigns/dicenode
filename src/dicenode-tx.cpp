...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dicenode Core dicenode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dicenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dicenode transaction") + "\n" +
                               "  dicenode-tx [options] -create [commands]   " + _("Create hex-encoded dicenode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dicenode transaction
