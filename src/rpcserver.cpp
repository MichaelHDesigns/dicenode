...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dicenode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dicenode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dicenode features */
        {"dicenode", "masternode", &masternode, true, true, false},
        {"dicenode", "listmasternodes", &listmasternodes, true, true, false},
        {"dicenode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dicenode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dicenode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dicenode", "masternodedebug", &masternodedebug, true, true, false},
        {"dicenode", "startmasternode", &startmasternode, true, true, false},
        {"dicenode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dicenode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dicenode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dicenode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dicenode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dicenode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dicenode", "mnbudget", &mnbudget, true, true, false},
        {"dicenode", "preparebudget", &preparebudget, true, true, false},
        {"dicenode", "submitbudget", &submitbudget, true, true, false},
        {"dicenode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dicenode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dicenode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dicenode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dicenode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dicenode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dicenode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dicenode", "checkbudgets", &checkbudgets, true, true, false},
        {"dicenode", "mnsync", &mnsync, true, true, false},
        {"dicenode", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> dicenode-cli " + methodname + " " + args + "\n";
}
