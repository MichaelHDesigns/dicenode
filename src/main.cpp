...
#if defined(NDEBUG)
#error "Dicenode cannot be compiled without assertions."
#endif
...
{
    RenameThread("dicenode-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DICENODE: We use certain sporks during IBD, so check to see if they are
