...
int nStakeTargetSpacing = 60; // Dicenode: 1 minute blocks during POS (block 201+)
...
{
    // Dicenode will hash in the transaction hash and the index number in order to make sure each hash is unique
