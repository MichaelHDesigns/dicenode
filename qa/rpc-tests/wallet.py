...
#   c) node1 mines 32 blocks, so now node 0 has 500000DNO, node 1 has 4250DNO, node2 has none.
#   d) node0 sends 601 DNO to node2, in two transactions (301 DNO, then 300 DNO).
